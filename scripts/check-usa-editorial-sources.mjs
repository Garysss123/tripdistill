...
const names=['boston','philadelphia','dc','new-england','chicago','seattle','portland-oregon','san-francisco','los-angeles','san-diego','sierra-parks',...(process.argv.includes('--drafts')?['las-vegas','utah-parks','arizona','colorado']:[])];
