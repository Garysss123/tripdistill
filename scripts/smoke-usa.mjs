...
for(const [asset,selector] of [['boston','.bo-cover'],['philadelphia','.ph-cover'],['dc','.dc-city-cover'],['new-england','.ne-region-cover'],['chicago','.ch-city-cover'],['seattle','.se-city-cover'],['portland-oregon','.po-city-cover'],['san-francisco','.sf-city-cover'],['los-angeles','.la-city-cover'],['san-diego','.sd-city-cover'],['sierra-parks','.si-region-cover'],['las-vegas','.lv-city-cover'],['utah-parks','.ut-region-cover'],['arizona','.az-region-cover'],['colorado','.co-region-cover'],['yellowstone-tetons','.yt-region-cover'],['new-orleans','.no-city-cover'],['atlanta','.at-city-cover'],['texas','.tx-region-cover'],['miami','.mi-city-cover'],['orlando','.or-city-cover'],['alaska','.ak-region-cover'],['hawaii','.hi-islands-cover'],['usa-country','.uc-cover']])jobs.push({label:asset+' editorial stylesheet',run:async()=>{const css=await(await get(`/css/${asset}-editorial.css?v=20260911-1`)).text();if(!css.includes(selector)||!css.includes('max-width:520px'))throw Error('Editorial/responsive CSS missing');}});
